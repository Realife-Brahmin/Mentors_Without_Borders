...
# ╔═╡ 3e260b96-ac0e-4297-94fa-32729fedc390
using DifferentialEquations

# ╔═╡ 9f91931a-23ea-49f1-96d7-c511b034bdc1
using Plots

# ╔═╡ 644a7de6-2361-464c-924e-044e2b5eae01
using PlutoUI

# ╔═╡ d25aa89a-0c98-4ff7-9e27-970d30ff19d2
plotly()

# ╔═╡ 859464e0-0425-11ee-1c69-553008f64671
md"# Lotka-Volterra Equations"

# ╔═╡ 4b65bd00-95f9-41c0-ad2a-c1a5cceb15c5
md"Source: [Wikipedia Article](https://en.wikipedia.org/wiki/Lotka%E2%80%93Volterra_equations)"

# ╔═╡ a58f3c7e-39ce-4d12-9ac6-b00e4f98c09e
md"## Add Packages"

# ╔═╡ c9d71b2b-ffc1-444d-8b1b-233926c78ba4
md"$\begin{align}
\frac{dx}{dt} &= αx - βxy \nonumber \\
\frac{dy}{dt} &= \delta xy - \gamma y
\end{align}$"

# ╔═╡ 7882e2ac-862f-4dac-9822-c8f44fb8583c
md" where $x$ is the number of prey (e.g., baboons),"

# ╔═╡ f1f41c17-4151-4bf9-a7aa-55d10c9c8dac
md"and $y$ is the number of some predator (e.g., cheetahs),"

# ╔═╡ 3c59bb65-2fe0-4d94-a62f-7eb1f2c57fa5
md"and $\frac{dx}{dt}$ and $\frac{dy}{dt}$ represent the instantaneous growth rates of the two populations,"

# ╔═╡ 77f007ea-9fd9-4e3f-bf35-7ac24b783239
md"and $t$ represents time."

# ╔═╡ 7d5910f6-d90a-4a4f-b160-01e6d162f798
md"and $\alpha, \beta, \gamma, \delta$ are positive real parameters describing the interaction of the two species."

# ╔═╡ c3447f62-f5c3-4e1a-87ed-7ece93e5b798
md"#### DifferentialEquations.jl"

# ╔═╡ 6bcc0f1c-b4ed-47a1-b3a8-57ad0435ddfd
md"$f(du, u, p, t) = 
\begin{cases}
...
# ╔═╡ 241b340b-9de8-46d5-9347-a37114ce50f9
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "9d130f7389f2ce02a9cbc2b2e52a24772c76e3d2"
...
git-tree-sha1 = "1db390298a1a31080b0bd417188bf4da0ef5e698"
