...
# ╔═╡ 5780598a-4e4d-46da-a506-a07af81fd3b2
using Symbolics, SymbolicNumericIntegration

# ╔═╡ 3ba69dee-0356-11ee-285f-a99ccd44c55c
md"# SymbolicNumericIntegration.jl Demo"

# ╔═╡ c73cd7ab-de62-496a-9fdd-c73cc9f2f7e7
md"## Load Packages"

# ╔═╡ 288c6b30-dbb5-4286-b298-2815fa060a56
md"## Example from Documentation"

# ╔═╡ ef411ced-e46a-4e0f-b288-7f39c27f0aff
@variables t x y z

# ╔═╡ 0990a4fd-04f0-4f4d-bc57-47fde47e8d18
ex1 = 3x^3 + 2x - 5

# ╔═╡ 969ab208-b216-4212-afb4-13fd45aaff71
integrate(ex1)

# ╔═╡ d30e7f8e-a7a6-46d3-b5c9-9577ffa8383f
integrate(ex1)[1]

# ╔═╡ a7088289-6d22-4177-a914-91f3854e63cc
md"## Example from Episode 8_07"

# ╔═╡ 95169a27-d1d8-45be-bdfe-f6e4bf1685c4
f = sqrt(x)

# ╔═╡ 757d3b1c-c824-4e7e-b448-827d85089529
integrate(f)

# ╔═╡ 136b1cd5-ae6a-41c3-a24b-9b8af1c0dde3
to_compute = integrate(f)[1]

# ╔═╡ 78368a2c-1e5d-472d-9a7e-a12cc18e2103
f_expr = build_function(to_compute, x)

# ╔═╡ d0b68ed9-3744-46a4-87ed-8fe390f7a20c
myf = eval(f_expr)

# ╔═╡ 9fd43d23-bd18-409e-95a1-448c893ee37e
area = myf(4)

# ╔═╡ a36cbb80-2003-4a92-9269-8373a4d3d848
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "1b5b07b605e543000a7c788c4ab3679b3403cd57"
...
git-tree-sha1 = "b91afb2a66627f7c24c6f972295292161f09768b"
uuid = "2445eb08-9709-466a-b3fc-47e12bd697a2"
version = "1.2.0"

[[deps.DataDrivenSparse]]
deps = ["DataDrivenDiffEq", "LinearAlgebra", "Printf", "Reexport"]
git-tree-sha1 = "62c1877475c7fbad13a3df008e919960bcecb842"
...
git-tree-sha1 = "c7a9587f2fbac4983c9b37a3a716dceaa08fdb06"
...
git-tree-sha1 = "7112661266ce37abbf9fa1d73dbf28d98bb324e0"
...
[[deps.SymbolicNumericIntegration]]
deps = ["DataDrivenDiffEq", "DataDrivenSparse", "DataStructures", "LinearAlgebra", "Optim", "SpecialFunctions", "Statistics", "SymbolicUtils", "Symbolics"]
git-tree-sha1 = "4ec62fbc628bb782785f940296efdfd8807bf037"
